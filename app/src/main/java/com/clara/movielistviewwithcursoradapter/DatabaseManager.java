...
public class DatabaseManager {
	...
	public Cursor getAllMovies() {
		//TOD Fetch all data, sort by movie name
		Cursor cursor = db.query(DB_TABLE,null,null,null,null,null,MOVIE_NAME_COL);
		return cursor; //TOD replace this with a Cursor
	}
	...
	public boolean addMovie(String name, float rating) {
		...
		try {
			...
			return false; //TOD replace with boolean reflecting success of operation
		}
	}


	public boolean updateRating(int movieID, float rating) {
		//TOD update the rating for a movie, but movie id.
