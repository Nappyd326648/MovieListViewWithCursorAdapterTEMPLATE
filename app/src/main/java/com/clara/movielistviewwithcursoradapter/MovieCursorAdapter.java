...
public class MovieCursorAdapter extends CursorAdapter {
	...
	public void bindView(View view, Context context, final Cursor cursor) {
		...
		//TOD get references to components that will contain data from database
		...
		//TOD register listener for user changing RatingBar to change rating for this movie
		...
		//TOD If user changes rating, notify the RatingChangedListener
