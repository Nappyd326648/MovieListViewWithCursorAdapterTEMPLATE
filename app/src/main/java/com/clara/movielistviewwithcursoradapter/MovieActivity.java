...
public class MovieActivity extends AppCompatActivity implements MovieCursorAdapter.RatingChangedListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//TOD Create DatabaseManager object
		...
		//TOD create cursor
		//TOO create CursorAdapter
		//TDO Configure ListView to use this adapter
		...
		addNew.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				//TOD Add this movie to the database
				//TOD Update list
	...
	public void notifyRatingChanged(int movieID, float rating) {
		...
		//TOD Update DB, and then update the cursor for the ListView if necessary.
